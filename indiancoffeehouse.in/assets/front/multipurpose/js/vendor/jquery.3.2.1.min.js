! function(e, t) {
    ...
    m.event = {
        ...
        add: function(e, t, n, r, i) {
            ...
            if (v)
                for (n.handler && (n = (o = n).handler, i = o.selector), i && m.find.matchesSelector(he, i), n.guid || (n.guid = m.guid++), (u = v.events) || (u = v.events = {}), (a = v.handle) || (a = v.handle = function(t) {
    ...
    function Le(e, t, n, r) {
        ...
        if (p && (o = (i = de(t, e[0].ownerDocument, !1, e, r)).firstChild, 1 === i.childNodes.length && (i = o), o || r)) {
            ...
            if (u)
                for (c = s[s.length - 1].ownerDocument, m.map(s, je), f = 0; f < u; f++) l = s[f], ue.test(l.type || "") && !U.access(l, "globalEval") && m.contains(c, l) && (l.src ? m._evalUrl && m._evalUrl(l.src) : g(l.textContent.replace(Se, ""), c))
        }
        return e
    }
    ...
    m.extend({
        ...
        clone: function(e, t, n) {
            ...
            if (!(h.noCloneChecked || 1 !== e.nodeType && 11 !== e.nodeType || m.isXMLDoc(e)))
                for (a = ce(s), r = 0, i = (o = ce(e)).length; r < i; r++) qe(o[r], a[r]);
            if (t)
                if (n)
                    for (o = o || ce(e), a = a || ce(s), r = 0, i = o.length; r < i; r++) Ae(o[r], a[r]);
                else Ae(e, s);
    ...
    function it(e, t, n) {
        ...
        for (function(e, t) {
            ...
            if (r = it.prefilters[o].call(l, e, c, l.opts)) return m.isFunction(r.stop) && (m._queueHooks(l.elem, l.opts.queue).stop = m.proxy(r.stop, r)), r;
