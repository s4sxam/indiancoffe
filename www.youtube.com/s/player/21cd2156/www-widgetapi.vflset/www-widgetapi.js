(function() {
    ...
    r("Map", function(a) {
        ...
        function d(e, g) {
            var l = g && typeof g;
            l == "object" || l == "function" ? h.has(g) ? l = h.get(g) : (l = "" + ++f, h.set(g, l)) : l = "p_" + g;
            var m = e[0][l];
            if (m && G(e[0], l))
    ...
    r("Array.from", function(a) {
        return a ? a : function(b, c, d) {
            ...
            if (typeof h == "function") {
                b = h.call(b);
                for (var f = 0; !(h = b.next()).done;) k.push(c.call(d, h.value, f++))
            } else
    ...
    */
    ...
    var ua = Array.prototype.indexOf ? function(a, b) {
        ...
        va = Array.prototype.forEach ? function(a, b, c) {
            ...
            for (var d = a.length, k = typeof a === "string" ? a.split("") : a, h = 0; h < d; h++) h in k && b.call(c, k[h], h, a)
        };
    ...
    */
    ...
    n.P = function(a, b) {
        ...
        if (c) {
            ...
            if (this.u)
                for (h = 0; h < c.length; h++) k = c[h], ib(this.g[k + 1], this.g[k + 2], d);
            else {
                this.m++;
                try {
            ...
            switch (c.g) {
                ...
                case 2:
                    ...
                    return c.u(Promise.all(b.map(function(d) {
                        var k;
                        return F(function(h) {
                            if (h.g == 1) return h.I(2), h.u(navigator.permissions.query({
                                name: "top-level-storage-access",
                                requestedOrigin: d
                            }), 4);
                            if (h.g != 2) return k = h.m, k.state === "prompt" && a.g.push(d), h.H(0);
                            h.F();
                            h.G()
                        })
                    })), 4);
    ...
    function zb(a, b) {
        ...
        window.location.href && va(["debugjs", "debugcss"], function(k) {
            ...
            b: {
                var e = 0;
                for (var g = k.length;
                    (e = h.indexOf(k, e)) >= 0 && e < f;) {
                    var l = h.charCodeAt(e - 1);
                    if (l == 38 || l == 63)
                        if (l = h.charCodeAt(e + g), !l || l == 61 || l == 38 || l == 35) break b;
                    e += g + 1
                }
                e = -1
            }
    ...
    function Gb(a, b, c) {
        Z || (Z = {}, Kb = new Set, Mb.addEventListener("message", function(d) {
            a: if (Kb.has(d.origin)) {
                ...
                var h = Z[k.id];
                if (h && d.origin === h.X) switch (d = h.aa, d.m = !0, d.m && (va(d.l, d.sendMessage, d), d.l.length = 0), h = k.event, k = k.info, h) {
                    ...
                    case "initialDelivery":
                        I(k) && (clearInterval(d.h), d.playerInfo = {}, d.A = {}, Jb(d, k.apiInterface), Ib(d, k));
                        break;
